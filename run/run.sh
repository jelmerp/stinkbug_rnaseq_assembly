...
#? Uses the script `FilterUncorrectabledPEfastq.py`
#? from https://github.com/harvardinformatics/TranscriptomeAssemblyTools/tree/7ef2eccf2926f64bc1a3e97083c4bbfabcfbf3f2
...
# Read normalization for TransABYSS and SPAdes
